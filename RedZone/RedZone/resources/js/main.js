...
var log0 = new Image(); log0.src ="resources/images/log0.png";
var wall = new Image(); wall.src ="resources/images/wall.png";
var balleImg;
var balles =[];
var compt;
...
function menuLoop () {
	...
	context.drawImage(log0,0,0,log0.width,log0.height,canvasWidth/28,-canvasHeight/5.5,canvasWidth,canvasHeight);
...
function gameStateInit () {
	...
	menuButtons.push(new Button(canvasWidth / 2.8,canvasHeight / 2,400,150,"New Game",newGame));
	goToMenu();
}
